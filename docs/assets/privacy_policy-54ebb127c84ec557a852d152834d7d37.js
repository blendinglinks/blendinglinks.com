...
(function (e, t) {
  ...
  function u(e, t, i, n) {
    if (rt.acceptData(e)) {
      var r, o, a = rt.expando, s = e.nodeType, l = s ? rt.cache : e, c = s ? e[a] : e[a] && a;
      if (c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof t) return c || (c = s ? e[a] = X.pop() || rt.guid++ : a), l[c] || (l[c] = s ? {} : {toJSON: rt.noop}), ("object" == typeof t || "function" == typeof t) && (n ? l[c] = rt.extend(l[c], t) : l[c].data = rt.extend(l[c].data, t)), o = l[c], n || (o.data || (o.data = {}), o = o.data), void 0 !== i && (o[rt.camelCase(t)] = i), "string" == typeof t ? (r = o[t], null == r && (r = o[rt.camelCase(t)])) : r = o, r
    }
  }

  function d(e, t, i) {
    if (rt.acceptData(e)) {
      var n, r, o = e.nodeType, a = o ? rt.cache : e, s = o ? e[rt.expando] : rt.expando;
      if (a[s]) {
  ...
  function m(e) {
    var t = zt.split("|"), i = e.createDocumentFragment();
  ...
  function g(e, t) {
    ...
    if (!o) for (o = [], i = e.childNodes || e; (n = i[r]) != null; r++) !t || rt.nodeName(n, t) ? o.push(n) : rt.merge(o, g(n, t));
  ...
  function _(e, t) {
    for (var i, n = 0; (i = e[n]) != null; n++) rt._data(i, "globalEval", !t || rt._data(t[n], "globalEval"))
  }

  function k(e, t) {
    if (t.nodeType === 1 && rt.hasData(e)) {
      var i, n, r, o = rt._data(e), a = rt._data(t, o), s = o.events;
      if (s) {
        delete a.handle, a.events = {};
        for (i in s) for (n = 0, r = s[i].length; r > n; n++) rt.event.add(t, i, s[i][n])
      }
  ...
  function A(e, t) {
    if (t in e) return t;
    for (var i = t.charAt(0).toUpperCase() + t.slice(1), n = t, r = hi.length; r--;) if (t = hi[r] + i, t in e) return t;
    return n
  }
  ...
  function I(e, t, i) {
    var n = !0, r = "width" === t ? e.offsetWidth : e.offsetHeight, o = ei(e),
  ...
  function F(e, t, i) {
    for (var n, r = (bi[t] || []).concat(bi["*"]), o = 0, a = r.length; a > o; o++) if (n = r[o].call(i, t, e)) return n
  }

  function z(e, t, i) {
    var n, r, o, a, s, l, c, u, d = this, h = {}, p = e.style, f = e.nodeType && Pt(e), m = rt._data(e, "fxshow");
    ...
    if (rt.isEmptyObject(h)) ("none" === c ? S(e.nodeName) : c) === "inline" && (p.display = c); else {
  ...
  function L(e, t) {
    var i, n, r, o, a;
    for (i in e) if (n = rt.camelCase(i), r = t[n], o = e[i], rt.isArray(o) && (r = o[1], o = e[i] = o[0]), i !== n && (e[n] = o, delete e[i]), a = rt.cssHooks[n], a && "expand" in a) {
  ...
  function R(e, t, i) {
    var n, r, o = 0, a = yi.length, s = rt.Deferred().always(function () {
      delete l.elem
    }), l = function () {
      if (r) return !1;
    ...
    for (L(u, c.opts.specialEasing); a > o; o++) if (n = yi[o].call(c, e, u, c.opts)) return n;
  ...
  function j(e) {
    return function (t, i) {
      ...
      var n, r = 0, o = t.toLowerCase().match(bt) || [];
      if (rt.isFunction(i)) for (; n = o[r++];) n.charAt(0) === "+" ? (n = n.slice(1) || "*", (e[n] = e[n] || []).unshift(i)) : (e[n] = e[n] || []).push(i)
    }
  }
  ...
  function q(e, t, i, n) {
    ...
    }); else if (i || rt.type(t) !== "object") n(e, t); else for (r in t) q(e + "[" + r + "]", t[r], i, n)
  }
  ...
  var X = [], V = X.slice, K = X.concat, Q = X.push, J = X.indexOf, Z = {}, et = Z.toString, tt = Z.hasOwnProperty,
    it = {}, nt = "1.11.1", rt = function (e, t) {
  ...
  rt.fn = rt.prototype = {
    ...
    var e, t, i, n, r, o, a = arguments[0] || {}, s = 1, l = arguments.length, c = !1;
    for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || rt.isFunction(a) || (a = {}), s === l && (a = this, s--); l > s; s++) if ((r = arguments[s]) != null) for (n in r) e = a[n], i = r[n], a !== i && (c && i && (rt.isPlainObject(i) || (t = rt.isArray(i))) ? (t ? (t = !1, o = e && rt.isArray(e) ? e : []) : o = e && rt.isPlainObject(e) ? e : {}, a[n] = rt.extend(c, o, i)) : void 0 !== i && (a[n] = i));
    return a
  }, rt.extend({
    expando: "jQuery" + (nt + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
      ...
      var r, o = 0, a = e.length, s = i(e);
      if (n) {
        if (s) for (; a > o && (r = t.apply(e[o], n), r !== !1); o++) ; else for (o in e) if (r = t.apply(e[o], n), r === !1) break
      ...
      if (i !== i) for (; t[n] !== void 0;) e[r++] = t[n++];
      return e.length = r, e
    }, grep: function (e, t, i) {
      for (var n, r = [], o = 0, a = e.length, s = !i; a > o; o++) n = !t(e[o], o), n !== s && r.push(e[o]);
      return r
    }, map: function (e, t, n) {
      var r, o = 0, a = e.length, s = i(e), l = [];
      if (s) for (; a > o; o++) r = t(e[o], o, n), null != r && l.push(r); else for (o in e) r = t(e[o], o, n), null != r && l.push(r);
      return K.apply([], l)
 ...
 */
    function (e) {
      ...
      function a(e, t) {
        var i = t && e, n = i && e.nodeType === 1 && t.nodeType === 1 && (~t.sourceIndex || X) - (~e.sourceIndex || X);
        if (n) return n;
      ...
      function p(e, t, i) {
        var n = t.dir, r = i && "parentNode" === n, o = W++;
        return t.first ? function (t, i, o) {
          for (; t = t[n];) if (t.nodeType === 1 || r) return e(t, i, o)
        } : function (t, i, a) {
          var s, l, c = [B, o];
          if (a) {
            for (; t = t[n];) if ((t.nodeType === 1 || r) && e(t, i, a)) return !0
          } else for (; t = t[n];) if (t.nodeType === 1 || r) {
      ...
      function v(e, t, i, r, o, a) {
        return r && !r[j] && (r = v(r)), o && !o[j] && (o = v(o, a)), n(function (n, a, s, l) {
          var c, u, d, h = [], p = [], f = a.length, v = n || m(t || "*", s.nodeType ? [s] : s, []),
            y = !e || !n && t ? v : g(v, h, e, s, l), b = i ? o || (n ? e : f || r) ? [] : a : y;
          if (i && i(y, b, s, l), r) for (c = g(b, p), r(c, [], s, l), u = c.length; u--;) (d = c[u]) && (b[p[u]] = !(y[p[u]] = d));
          if (n) {
            if (o || e) {
              if (o) {
      ...
      function y(e) {
        ...
        }]; r > s; s++) if (i = k.relative[e[s].type]) u = [p(f(u), i)]; else {
          if (i = k.filter[e[s].type].apply(null, e[s].matches), i[j]) {
            for (n = ++s; r > n && !k.relative[e[n].type]; n++) ;
            return v(s > 1 && f(u), s > 1 && h(e.slice(0, s - 1).concat({value: e[s - 2].type === " " ? "*" : ""})).replace(lt, "$1"), i, n > s && y(e.slice(s, n)), r > n && y(e = e.slice(n)), r > n && h(e))
          }
          u.push(i)
        }
        return f(u)
      ...
      function b(e, i) {
        var r = i.length > 0, o = e.length > 0, a = function (n, a, s, l, c) {
          var u, d, h, p = 0, f = "0", m = n && [], v = [], y = P, b = n || o && k.find.TAG("*", c),
            x = B += null == y ? 1 : Math.random() || .1, _ = b.length;
      ...
      var x, _, k, w, C, S, T, A, P, E, D, I, M, N, O, F, z, L, R, j = "sizzle" + -new Date, H = e.document, B = 0,
        W = 0, $ = i(), q = i(), U = i(), G = function (e, t) {
          return e === t && (D = !0), 0
        }, Y = "undefined", X = 1 << 31, V = {}.hasOwnProperty, K = [], Q = K.pop, J = K.push, Z = K.push, et = K.slice,
        ...
        dt = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]", "g"), ht = new RegExp(st),
        pt = new RegExp("^" + ot + "$"), ft = {
          ID: new RegExp("^#(" + rt + ")"),
          CLASS: new RegExp("^\\.(" + rt + ")"),
        ...
        yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, xt = /'|\\/g,
        _t = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)", "ig"), kt = function (e, t, i) {
          var n = "0x" + t - 65536;
      ...
      _ = t.support = {}, C = t.isXML = function (e) {
        ...
        var i = k.attrHandle[t.toLowerCase()], n = i && V.call(k.attrHandle, t.toLowerCase()) ? i(e, t, !O) : void 0;
          ...
          TAG: function (e) {
            ...
            return 1 === n && 0 === r ? function (e) {
              ...
              if (g) {
                if (o) {
                  for (; m;) {
                    for (d = t; d = d[m];) if (s ? d.nodeName.toLowerCase() === v : d.nodeType === 1) return !1;
                    f = m = "only" === e && !f && "nextSibling"
                  }
                  return !0
                }
                if (f = [a ? g.firstChild : g.lastChild], a && y) {
                  for (u = g[j] || (g[j] = {}), c = u[e] || [], p = c[0] === B && c[1], h = c[0] === B && c[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (h = p = 0) || f.pop();) if (d.nodeType === 1 && ++h && d === t) {
                    u[e] = [B, p, h];
                    break
                  }
                } else if (y && (c = (t[j] || (t[j] = {}))[e]) && c[0] === B) h = c[1]; else for (; (d = ++p && d && d[m] || (h = p = 0) || f.pop()) && ((s ? d.nodeName.toLowerCase() !== v : d.nodeType !== 1) || !++h || (y && ((d[j] || (d[j] = {}))[e] = [B, h]), d !== t));) ;
        ...
        pseudos: {
          not: n(function (e) {
            ...
            return pt.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(_t, kt).toLowerCase(), function (t) {
              var i;
              do if (i = O ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang")) return i = i.toLowerCase(), i === e || i.indexOf(e + "-") === 0; while ((t = t.parentNode) && t.nodeType === 1);
              return !1
            }
          }), target: function (t) {
      ...
      return d.prototype = k.filters = k.pseudos, k.setFilters = new d, S = t.tokenize = function (e, i) {
        ...
        var r, o, a, s, l, c = "function" == typeof e && e, d = !n && S(e = c.selector || e);
        if (i = i || [], d.length === 1) {
          ...
          for (r = ft.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !k.relative[s = a.type]);) if ((l = k.find[s]) && (n = l(a.matches[0].replace(_t, kt), bt.test(o[0].type) && u(t.parentNode) || t))) {
  ...
  rt.filter = function (e, t, i) {
    ...
    find: function (e) {
      ...
      if ("string" != typeof e) return this.pushStack(rt(e).filter(function () {
        for (t = 0; r > t; t++) if (rt.contains(n[t], this)) return !0
      }));
  ...
  var pt, ft = e.document, mt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, gt = rt.fn.init = function (e, t) {
    var i, n;
    if (!e) return this;
    if ("string" == typeof e) {
      ...
      if (i[1]) {
        if (t = t instanceof rt ? t[0] : t, rt.merge(this, rt.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ft, !0)), dt.test(i[1]) && rt.isPlainObject(t)) for (i in t) rt.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
        return this
      }
  ...
  rt.extend({
    ...
    has: function (e) {
      ...
      for (var i, n = 0, r = this.length, o = [], a = ut.test(e) || "string" != typeof e ? rt(e, t || this.context) : 0; r > n; n++) for (i = this[n]; i && i !== t; i = i.parentNode) if (i.nodeType < 11 && (a ? a.index(i) > -1 : i.nodeType === 1 && rt.find.matchesSelector(i, e))) {
        o.push(i);
        break
      }
  ...
  rt.Callbacks = function (e) {
    ...
    var t, i, n, r, a, s, l = [], c = !e.once && [], u = function (o) {
      for (i = e.memory && o, n = !0, a = s || 0, s = 0, r = l.length, t = !0; l && r > a; a++) if (l[a].apply(o[0], o[1]) === !1 && e.stopOnFalse) {
        i = !1;
        break
      }
      ...
      add: function () {
        ...
        return l && rt.each(arguments, function (e, i) {
          for (var n; (n = rt.inArray(i, l, n)) > -1;) l.splice(n, 1), t && (r >= n && r--, a >= n && a--)
        }), this
      }, has: function (e) {
    ...
    Deferred: function (e) {
      ...
      var t, i, n, r = 0, o = V.call(arguments), a = o.length, s = 1 !== a || e && rt.isFunction(e.promise) ? a : 0,
        l = 1 === s ? e : rt.Deferred(), c = function (e, i, n) {
          return function (r) {
            i[e] = this, n[e] = arguments.length > 1 ? V.call(arguments) : r, n === t ? l.notifyWith(i, n) : --s || l.resolveWith(i, n)
          }
        };
      if (a > 1) for (t = new Array(a), i = new Array(a), n = new Array(a); a > r; r++) o[r] && rt.isFunction(o[r].promise) ? o[r].promise().done(c(r, n, o)).fail(l.reject).progress(c(r, i, t)) : --s;
  ...
  rt.fn.ready = function (e) {
    ...
    if (!_t) if (_t = rt.Deferred(), ft.readyState === "complete") setTimeout(rt.ready); else if (ft.addEventListener) ft.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", s, !1); else {
  ...
  it.ownLast = "0" !== kt, it.inlineBlockNeedsLayout = !1, rt(function () {
    ...
    var t = rt.noData[(e.nodeName + " ").toLowerCase()], i = +e.nodeType || 1;
  ...
  rt.extend({
    ...
    queue: function (e, t, i) {
      ...
      t = t || "fx";
      var i = rt.queue(e, t), n = i.length, r = i.shift(), o = rt._queueHooks(e, t), a = function () {
        rt.dequeue(e, t)
      };
    ...
    queue: function (e, t) {
      ...
      var i, n = 1, r = rt.Deferred(), o = this, a = this.length, s = function () {
        --n || r.resolveWith(o, [o])
      };
  ...
  var Tt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, At = ["Top", "Right", "Bottom", "Left"], Pt = function (e, t) {
    ...
    })), t)) for (; l > s; s++) t(e[s], i, a ? n : n.call(e[s], s, t(e[s], i)));
    return r ? e : c ? t.call(e) : l ? t(e[0], i) : o
  }, Dt = /^(?:checkbox|radio)$/i;
  (function () {
    var e = ft.createElement("input"), t = ft.createElement("div"), i = ft.createDocumentFragment();
  ...
  var It = /^(?:input|select|textarea)$/i, Mt = /^key/, Nt = /^(?:mouse|pointer|contextmenu)|click/,
    Ot = /^(?:focusinfocus|focusoutblur)$/, Ft = /^([^.]*)(?:\.(.+)|)$/;
  rt.event = {
    global: {},
    ...
    remove: function (e, t, i, n, r) {
      ...
      if (g && (u = g.events)) {
        for (t = (t || "").match(bt) || [""], c = t.length; c--;) if (s = Ft.exec(t[c]) || [], p = m = s[1], f = (s[2] || "").split(".").sort(), p) {
        ...
        } else for (p in u) rt.event.remove(e, p + t[c], i, n, !0);
        rt.isEmptyObject(u) && (delete g.handle, rt._removeData(e, "events"))
      }
    },
    trigger: function (t, i, n, r) {
      var o, a, s, l, c, u, d, h = [n || ft], p = tt.call(t, "type") ? t.type : t,
      ...
      if (s = u = n = n || ft, n.nodeType !== 3 && n.nodeType !== 8 && !Ot.test(p + rt.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[rt.expando] ? t : new rt.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), i = null == i ? [t] : rt.makeArray(i, [t]), c = rt.event.special[p] || {}, r || !c.trigger || c.trigger.apply(n, i) !== !1)) {
        ...
        for (d = 0; (s = h[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? l : c.bindType || p, o = (rt._data(s, "events") || {})[t.type] && rt._data(s, "handle"), o && o.apply(s, i), o = a && s[a], o && o.apply && rt.acceptData(s) && (t.result = o.apply(s, i), t.result === !1 && t.preventDefault());
    ...
    dispatch: function (e) {
      e = rt.event.fix(e);
      var t, i, n, r, o, a = [], s = V.call(arguments), l = (rt._data(this, "events") || {})[e.type] || [],
        c = rt.event.special[e.type] || {};
      if (s[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
        for (a = rt.event.handlers.call(this, e, l), t = 0; (r = a[t++]) && !e.isPropagationStopped();) for (e.currentTarget = r.elem, o = 0; (n = r.handlers[o++]) && !e.isImmediatePropagationStopped();) (!e.namespace_re || e.namespace_re.test(n.namespace)) && (e.handleObj = n, e.data = n.data, i = ((rt.event.special[n.origType] || {}).handle || n.handler).apply(r.elem, s), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
        return c.postDispatch && c.postDispatch.call(this, e), e.result
      }
    },
    handlers: function (e, t) {
      var i, n, r, o, a = [], s = t.delegateCount, l = e.target;
      if (s && l.nodeType && (!e.button || e.type !== "click")) for (; l != this; l = l.parentNode || this) if (l.nodeType === 1 && (l.disabled !== !0 || e.type !== "click")) {
    ...
    fix: function (e) {
      ...
      var t, i, n, r = e.type, o = e, a = this.fixHooks[r];
    ...
    mouseHooks: {
      ...
      filter: function (e, t) {
        var i, n, r, o = t.button, a = t.fromElement;
    ...
    simulate: function (e, t, i, n) {
      var r = rt.extend(new rt.Event, i, {type: e, isSimulated: !0, originalEvent: {}});
    ...
    setup: function () {
      return rt.nodeName(this, "form") ? !1 : (rt.event.add(this, "click._submit keypress._submit", function (e) {
        var t = e.target, i = rt.nodeName(t, "input") || rt.nodeName(t, "button") ? t.form : void 0;
    ...
    rt.event.special[t] = {
      setup: function () {
        var n = this.ownerDocument || this, r = rt._data(n, t);
        r || n.addEventListener(e, i, !0), rt._data(n, t, (r || 0) + 1)
      }, teardown: function () {
        var n = this.ownerDocument || this, r = rt._data(n, t) - 1;
  ...
  var zt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
    Lt = / jQuery\d+="(?:null|\d+)"/g, Rt = new RegExp("<(?:" + zt + ")[\\s/>]", "i"), jt = /^\s+/,
    Ht = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Bt = /<([\w:]+)/, Wt = /<tbody/i,
    $t = /<|&#?\w+;/, qt = /<(?:script|style|link)/i, Ut = /checked\s*(?:[^=]|=\s*.checked.)/i,
    Gt = /^$|\/(?:java|ecma)script/i, Yt = /^true\/(.*)/, Xt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Vt = {
    ...
    }, Kt = m(ft), Qt = Kt.appendChild(ft.createElement("div"));
  Vt.optgroup = Vt.option, Vt.tbody = Vt.tfoot = Vt.colgroup = Vt.caption = Vt.thead, Vt.th = Vt.td, rt.extend({
    clone: function (e, t, i) {
      ...
      if (it.html5Clone || rt.isXMLDoc(e) || !Rt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Qt.innerHTML = e.outerHTML, Qt.removeChild(o = Qt.firstChild)), !(it.noCloneEvent && it.noCloneChecked || e.nodeType !== 1 && e.nodeType !== 11 || rt.isXMLDoc(e))) for (n = g(o), s = g(e), a = 0; (r = s[a]) != null; ++a) n[a] && w(r, n[a]);
      if (t) if (i) for (s = s || g(e), n = n || g(o), a = 0; (r = s[a]) != null; a++) k(r, n[a]); else k(e, o);
      return n = g(o, "script"), n.length > 0 && _(n, !l && g(e, "script")), n = s = r = null, o
    }, buildFragment: function (e, t, i, n) {
      for (var r, o, a, s, l, c, u, d = e.length, h = m(t), p = [], f = 0; d > f; f++) if (o = e[f], o || 0 === o) if (rt.type(o) === "object") rt.merge(p, o.nodeType ? [o] : o); else if ($t.test(o)) {
        ...
        if (!it.leadingWhitespace && jt.test(o) && p.push(t.createTextNode(jt.exec(o)[0])), !it.tbody) for (o = "table" !== l || Wt.test(o) ? u[1] !== "<table>" || Wt.test(o) ? 0 : s : s.firstChild, r = o && o.childNodes.length; r--;) rt.nodeName(c = o.childNodes[r], "tbody") && !c.childNodes.length && o.removeChild(c);
        for (rt.merge(p, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
        s = h.lastChild
      } else p.push(t.createTextNode(o));
      for (s && h.removeChild(s), it.appendChecked || rt.grep(g(p, "input"), v), f = 0; o = p[f++];) if ((!n || rt.inArray(o, n) === -1) && (a = rt.contains(o.ownerDocument, o), s = g(h.appendChild(o), "script"), a && _(s), i)) for (r = 0; o = s[r++];) Gt.test(o.type || "") && i.push(o);
      return s = null, h
    }, cleanData: function (e, t) {
      for (var i, n, r, o, a = 0, s = rt.expando, l = rt.cache, c = it.deleteExpando, u = rt.event.special; (i = e[a]) != null; a++) if ((t || rt.acceptData(i)) && (r = i[s], o = r && l[r])) {
    ...
    text: function (e) {
      ...
      for (var i, n = e ? rt.filter(e, this) : this, r = 0; (i = n[r]) != null; r++) t || i.nodeType !== 1 || rt.cleanData(g(i)), i.parentNode && (t && rt.contains(i.ownerDocument, i) && _(g(i, "script")), i.parentNode.removeChild(i));
      return this
    }, empty: function () {
      ...
      e = K.apply([], e);
      var i, n, r, o, a, s, l = 0, c = this.length, u = this, d = c - 1, h = e[0], p = rt.isFunction(h);
      ...
      if (c && (s = rt.buildFragment(e, this[0].ownerDocument, !1, this), i = s.firstChild, s.childNodes.length === 1 && (s = i), i)) {
        ...
        if (r) for (a = o[o.length - 1].ownerDocument, rt.map(o, x), l = 0; r > l; l++) n = o[l], Gt.test(n.type || "") && !rt._data(n, "globalEval") && rt.contains(a, n) && (n.src ? rt._evalUrl && rt._evalUrl(n.src) : rt.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Xt, "")));
        s = i = null
      }
      return this
    }
  ...
  e.getComputedStyle ? (ei = function (e) {
    ...
    function t() {
      var t, i, n, r;
      i = ft.getElementsByTagName("body")[0], i && i.style && (t = ft.createElement("div"), n = ft.createElement("div"), n.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", i.appendChild(n).appendChild(t), t.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", o = a = !1, l = !0, e.getComputedStyle && (o = (e.getComputedStyle(t, null) || {}).top !== "1%", a = (e.getComputedStyle(t, null) || {width: "4px"}).width === "4px", r = t.appendChild(ft.createElement("div")), r.style.cssText = t.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", r.style.marginRight = r.style.width = "0", t.style.width = "1px", l = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), t.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", r = t.getElementsByTagName("td"), r[0].style.cssText = "margin:0;border:0;padding:0;display:none", s = r[0].offsetHeight === 0, s && (r[0].style.display = "", r[1].style.display = "none", s = r[0].offsetHeight === 0), i.removeChild(n))
    }
  ...
  var oi = /alpha\([^)]*\)/i, ai = /opacity\s*=\s*([^)]*)/, si = /^(none|table(?!-c[ea]).+)/,
    li = new RegExp("^(" + Tt + ")(.*)$", "i"), ci = new RegExp("^([+-])=(" + Tt + ")", "i"),
    ui = {position: "absolute", visibility: "hidden", display: "block"}, di = {letterSpacing: "0", fontWeight: "400"},
    hi = ["Webkit", "O", "Moz", "ms"];
  rt.extend({
    cssHooks: {
      opacity: {
    ...
    get: function (e, t) {
      ...
      var i = e.style, n = e.currentStyle, r = rt.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
    ...
    return t ? rt.swap(e, {display: "inline-block"}, ti, [e, "marginRight"]) : void 0
  ...
  var pi, fi, mi = /^(?:toggle|show|hide)$/, gi = new RegExp("^(?:([+-])=|)(" + Tt + ")([a-z%]*)$", "i"),
    vi = /queueHooks$/, yi = [z], bi = {
      "*": [function (e, t) {
        var i = this.createTween(e, t), n = i.cur(), r = gi.exec(t), o = r && r[3] || (rt.cssNumber[e] ? "" : "px"),
          a = (rt.cssNumber[e] || "px" !== o && +n) && gi.exec(rt.css(i.elem, e)), s = 1, l = 20;
        if (a && a[3] !== o) {
          o = o || a[3], r = r || [], a = +n || 1;
  ...
  rt.Animation = rt.extend(R, {
    ...
    fadeTo: function (e, t, i, n) {
      return this.filter(Pt).css("opacity", 0).show().end().animate({opacity: t}, e, i, n)
    }, animate: function (e, t, i, n) {
      var r = rt.isEmptyObject(e), o = rt.speed(t, i, n), a = function () {
      ...
      return "string" != typeof e && (i = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
        ...
        if (r) a[r] && a[r].stop && n(a[r]); else for (r in a) a[r] && a[r].stop && vi.test(r) && n(a[r]);
        for (r = o.length; r--;) o[r].elem !== this || null != e && o[r].queue !== e || (o[r].anim.stop(i), t = !1, o.splice(r, 1));
        (t || !i) && rt.dequeue(this, e)
      })
    }, finish: function (e) {
      return e !== !1 && (e = e || "fx"), this.each(function () {
        var t, i = rt._data(this), n = i[e + "queue"], r = i[e + "queueHooks"], o = rt.timers, a = n ? n.length : 0;
  ...
  rt.fn.extend({
    ...
    valHooks: {
      option: {
        ...
        get: function (e) {
          for (var t, i, n = e.options, r = e.selectedIndex, o = e.type === "select-one" || 0 > r, a = o ? null : [], s = o ? r + 1 : n.length, l = 0 > r ? s : o ? r : 0; s > l; l++) if (i = n[l], !(!i.selected && l !== r || (it.optDisabled ? i.disabled : i.getAttribute("disabled") !== null) || i.parentNode.disabled && rt.nodeName(i.parentNode, "optgroup"))) {
            if (t = rt(i).val(), o) return t;
            a.push(t)
          }
          return a
        }, set: function (e, t) {
          for (var i, n, r = e.options, o = rt.makeArray(t), a = r.length; a--;) if (n = r[a], rt.inArray(rt.valHooks.option.get(n), o) >= 0) try {
            n.selected = i = !0
          } catch (s) {
            n.scrollHeight
          } else n.selected = !1;
  ...
  var _i, ki, wi = rt.expr.attrHandle, Ci = /^(?:checked|selected)$/i, Si = it.getSetAttribute, Ti = it.input;
  rt.fn.extend({
    attr: function (e, t) {
    ...
    attr: function (e, t, i) {
      ...
      var i, n, r = 0, o = t && t.match(bt);
      if (o && e.nodeType === 1) for (; i = o[r++];) n = rt.propFix[i] || i, rt.expr.match.bool.test(i) ? Ti && Si || !Ci.test(i) ? e[n] = !1 : e[rt.camelCase("default-" + i)] = e[n] = !1 : rt.attr(e, i, ""), e.removeAttribute(Si ? i : n)
    }, attrHooks: {
      type: {
        set: function (e, t) {
  ...
  var Ai = /^(?:input|select|textarea|button|object)$/i, Pi = /^(?:a|area)$/i;
  rt.fn.extend({
    prop: function (e, t) {
  ...
  rt.fn.extend({
    addClass: function (e) {
      var t, i, n, r, o, a, s = 0, l = this.length, c = "string" == typeof e && e;
      if (rt.isFunction(e)) return this.each(function (t) {
        rt(this).addClass(e.call(this, t, this.className))
      });
      if (c) for (t = (e || "").match(bt) || []; l > s; s++) if (i = this[s], n = i.nodeType === 1 && (i.className ? (" " + i.className + " ").replace(Ei, " ") : " ")) {
        for (o = 0; r = t[o++];) n.indexOf(" " + r + " ") < 0 && (n += r + " ");
        a = rt.trim(n), i.className !== a && (i.className = a)
      }
      return this
    }, removeClass: function (e) {
      var t, i, n, r, o, a, s = 0, l = this.length, c = arguments.length === 0 || "string" == typeof e && e;
      if (rt.isFunction(e)) return this.each(function (t) {
      ...
      return "boolean" == typeof t && "string" === i ? t ? this.addClass(e) : this.removeClass(e) : rt.isFunction(e) ? this.each(function (i) {
        ...
        if ("string" === i) for (var t, n = 0, r = rt(this), o = e.match(bt) || []; t = o[n++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
      ...
      for (var t = " " + e + " ", i = 0, n = this.length; n > i; i++) if (this[i].nodeType === 1 && (" " + this[i].className + " ").replace(Ei, " ").indexOf(t) >= 0) return !0;
      return !1
    }
  ...
  var Ni, Oi, Fi = /#.*$/, zi = /([?&])_=[^&]*/, Li = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
    Ri = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ji = /^(?:GET|HEAD)$/, Hi = /^\/\//,
    Bi = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Wi = {}, $i = {}, qi = "*/".concat("*");
  try {
    Oi = location.href
  } catch (Ui) {
  ...
  Ni = Bi.exec(Oi.toLowerCase()) || [], rt.extend({
    ...
    ajax: function (e, t) {
      ...
      var n, r, o, a, s, l, c, u, d = rt.ajaxSetup({}, t), h = d.context || d,
        p = d.context && (h.nodeType || h.jquery) ? rt(h) : rt.event, f = rt.Deferred(),
        m = rt.Callbacks("once memory"), g = d.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", _ = {
          readyState: 0, getResponseHeader: function (e) {
            var t;
            if (2 === b) {
              if (!u) for (u = {}; t = Li.exec(a);) u[t[1].toLowerCase()] = t[2];
              t = u[e.toLowerCase()]
            }
  ...
  var Gi = /%20/g, Yi = /\[\]$/, Xi = /\r?\n/g, Vi = /^(?:submit|button|image|reset|file)$/i,
    ...
    serialize: function () {
      ...
      return this.map(function () {
        ...
        return null == i ? null : rt.isArray(i) ? rt.map(i, function (e) {
          return {name: t.name, value: e.replace(Xi, "\r\n")}
  ...
  var Qi = 0, Ji = {}, Zi = rt.ajaxSettings.xhr();
      ...
      return {
        send: function (i, n) {
          ...
          o.send(e.hasContent && e.data || null), t = function (i, r) {
            var s, l, c;
            if (t && (r || o.readyState === 4)) if (delete Ji[a], t = void 0, o.onreadystatechange = rt.noop, r) o.readyState !== 4 && o.abort(); else {
  ...
  rt.ajaxSetup({
    ...
    var r, o, a,
      s = t.jsonp !== !1 && (tn.test(t.url) ? "url" : typeof t.data == "string" && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && tn.test(t.data) && "data");
  ...
  rt.offset = {
    setOffset: function (e, t, i) {
      var n, r, o, a, s, l, c, u = rt.css(e, "position"), d = rt(e), h = {};
    ...
    rt.each({padding: "inner" + e, content: t, "": "outer" + e}, function (i, n) {
  ...
  var r = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || e.msRequestAnimationFrame || function (t) {
    ...
    var r = {}, o = t.createElement("div").style, a = function () {
      for (var e, t = ["t", "webkitT", "MozT", "msT", "OT"], i = 0, n = t.length; n > i; i++) if (e = t[i] + "ransform", e in o) return t[i].substr(0, t[i].length - 1);
      return !1
    }();
  ...
  n.prototype = {
    version: "5.2.0-snapshot", _init: function () {
      ...
      if (this.enabled && o.eventType[e.type] === this.initiated) {
        ...
        var t, n, r, a, s = e.touches ? e.touches[0] : e, l = s.pageX - this.pointX, c = s.pageY - this.pointY,
          u = o.getTime();
      ...
      if (this.enabled && o.eventType[e.type] === this.initiated) {
        ...
        var t, n, r = (e.changedTouches ? e.changedTouches[0] : e, o.getTime() - this.startTime), a = i.round(this.x),
          s = i.round(this.y), l = i.abs(a - this.startX), c = i.abs(s - this.startY), u = 0, d = "";
      ...
      var i = t ? o.removeEvent : o.addEvent, n = this.options.bindToWrapper ? this.wrapper : e;
      ...
      var s = this, l = this.x, c = this.y, u = o.getTime(), d = u + i;
...
PrivacyPolicy.prototype.start = function () {
  ...
  this.newMarkupValue = getParameterByName("newmarkup"), this.inIframe = getParameterByName("ifr") == "true", this.wHeight = getParameterByName("height") ? parseInt(getParameterByName("height")) : this.inIframe ? 600 : null, this.skipAnalytics = getParameterByName("an") == "no", this.phantomJs = getParameterByName("phantomjs") == "true"
  ...
  $(".iub_container").find("a").each(function () {
    $(this).hasClass("iframe-preserve") ? e.inIframe && $(this).attr("href", function (t, i) {
      return i.addUrlParameter("ifr", "true").addUrlParameter("height", e.wHeight || null).addUrlParameter("newmarkup", e.isOldMarkup() ? "no" : "yes")
    }) : $(this).attr("target") || ($(this).attr("target", "_blank"), $(this).attr("rel") !== "noopener" && $(this).attr("rel", "noopener"))
  })
